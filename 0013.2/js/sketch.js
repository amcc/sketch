...
window.onload = function () {
  ...
  let gridSize = 100;
  colourGroup(redGroup, gridSize, 0, "red");
  colourGroup(blueGroup, gridSize, 0.1, "blue");
  colourGroup(greenGroup, gridSize, 0.2, "green");

  // if not doing animation then use this to draw
  view.draw();
};

function colourGroup(parent, gridSize, zoff, colour) {
