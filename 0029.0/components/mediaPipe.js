...
const predictWebcam = async (video) => {
  ...
  // video.style.height = video.videoWidth * radio + "px";

  if (video && lastVideoTime !== video.currentTime && faceLandmarker) {
    lastVideoTime = video.currentTime;
    let results = faceLandmarker.detect(video, startTimeMs);
